...
links = paste("https://www.imdb.com", html_attr(name, "href"))
...
imdb_df = data.frame(name_of_series, number_of_episodes, number_of_seasons, genre, release_year, end_year, runtime, ratings, number_of_raters, number_of_reviews, number_of_critics_reviews)
names(imdb_df)=c("Series_Name","Number_of_episodes","Number_of_seasons","Genre","Year_released","End_year","Avg_runtime","Rating","Number_of_raters","Number_of_reviews","Number_of_critics_review")
imdb_df
